                    ...
                    <ul class="col navbar-nav ms-3">
                        ...
                        <div class="col-4 col-sm-6 p-0">
                            <li class="nav-item d-flex align-items-center"> 
                                <a class="nav-link" href="paginas/login.php">Registrarse</a>
                                <a target="_blank" type="button" href="paginas/colaPedido.php" class="btn btn-outline-primary">
                    ...
                    <div id="carouselC" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <a target="_blank" href="paginas/productos.php">
